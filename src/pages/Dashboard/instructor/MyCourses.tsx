...
const MyCourses: React.FC = () => {
  ...
  return (
    ...
    //         <Button variant="instructor" className="btn btn-instructor text-sm px-4 py-2 rounded-lg hover:bg-neon-purple/10 hover:text-white hover:border hover:border-neon-purple/30 transition-all duration-300 bg-neon-blue/20 text-white border border-neon-blue/30">
    //           Create New Course
    //         </Button>
    //       </Link>
    //     </div>
